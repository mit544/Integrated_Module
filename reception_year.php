      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item active" aria-current="page" href="reception_year.php">Reception Year</a></li>
    ...
    <div class="form">
      ...
      <div class="container text-center" style="margin-right:px;">
        ...
        <table id="tbl">
          ...
          $sql = mysqli_query($link, "SELECT * FROM pupils WHERE Class_ID='11118'");

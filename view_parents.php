            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="library.php">Reception Year</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year One</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year Two</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year Three</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year Four</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year Five</a></li>
                            <li><a class="dropdown-item" href="view_library.php">Year Six</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
